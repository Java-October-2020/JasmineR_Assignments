...
public class stringManipulator {
    ...
    public static void GetIndexOrNull(String input, char c) {
        return input.indexOf(c) != -1 ? input.indexOf(c) : null;
    }

    public static void ConcatSubstring(String input, int idxA, int idxB, String replacement) {
        String substr;
        try{
    ...
    public static void RandomString(int numChars) {
        String output = "";
        Random r = new Random();
