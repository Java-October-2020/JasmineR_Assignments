package com.jasmine.languages.controllers;
...
import com.jasmine.languages.services.LanguagesService;
...
public class LanguagesController {
    ...
    @RequestMapping("/new")
    public String New(@ModelAttribute("language") Languages language) {
        return "new.jsp";
    }
    @RequestMapping(value="/", method=RequestMethod.POST)
    public String Create(@Valid @ModelAttribute("language") Languages lang, BindingResult result, @RequestParam Map<String,String> body) {
        if(result.hasErrors())
            return "new.jsp";
